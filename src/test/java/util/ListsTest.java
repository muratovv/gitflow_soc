...
public class ListsTest {
    ...
    public void zipOverlappedPairs() throws Exception {
        List<Pair<Integer, Integer>> pairs = Lists.zipOverlappedPairs(ImmutableList.of(1, 2, 3, 4));
    ...
    public void emptyZipOverlappedPairs() throws Exception {
        List<Pair<Integer, Integer>> pairs = Lists.zipOverlappedPairs(ImmutableList.of(1));
